...
func (sc *StudentCreate) SetCollege(s string) *StudentCreate {
	sc.mutation.SetCollege(s)
	return sc
}

// SetSubject sets the "subject" field.
func (sc *StudentCreate) SetSubject(s string) *StudentCreate {
	sc.mutation.SetSubject(s)
	return sc
}

// SetClass sets the "class" field.
func (sc *StudentCreate) SetClass(s string) *StudentCreate {
	sc.mutation.SetClass(s)
	return sc
}

// SetIdentity sets the "identity" field.
func (sc *StudentCreate) SetIdentity(s string) *StudentCreate {
...
func (sc *StudentCreate) SetUserIDID(id int) *StudentCreate {
	sc.mutation.SetUserIDID(id)
	return sc
}

// SetUserID sets the "user_id" edge to the User entity.
func (sc *StudentCreate) SetUserID(u *User) *StudentCreate {
...
func (sc *StudentCreate) check() error {
	...
	if _, ok := sc.mutation.College(); !ok {
		return &ValidationError{Name: "college", err: errors.New(`ent: missing required field "Student.college"`)}
	}
	if _, ok := sc.mutation.Subject(); !ok {
		return &ValidationError{Name: "subject", err: errors.New(`ent: missing required field "Student.subject"`)}
	}
	if _, ok := sc.mutation.Class(); !ok {
		return &ValidationError{Name: "class", err: errors.New(`ent: missing required field "Student.class"`)}
	}
	if _, ok := sc.mutation.Identity(); !ok {
		return &ValidationError{Name: "identity", err: errors.New(`ent: missing required field "Student.identity"`)}
	}
	if _, ok := sc.mutation.UserIDID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent: missing required edge "Student.user_id"`)}
	}
	return nil
}
